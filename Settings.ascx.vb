...
''' 
''' Because the control inherits from Dnn_module_kk_aj_Publik_detailSettingsBase you have access to any custom properties
''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
''' </summary>
''' -----------------------------------------------------------------------------
Public Class Settings
    Inherits Dnn_module_kk_aj_Publik_detailSettingsBase
