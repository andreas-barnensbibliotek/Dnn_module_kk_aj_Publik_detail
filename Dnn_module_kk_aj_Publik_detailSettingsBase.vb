...
' are accessible to your module's controls (that inherity from Dnn_module_kk_aj_Publik_detailModuleBase
' 
' </summary>

Public Class Dnn_module_kk_aj_Publik_detailSettingsBase
